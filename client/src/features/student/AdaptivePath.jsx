...
export default function AdaptivePath({ recommendations, topicMastery, learningMode, onChangeMode, onOpenCourse, onOpenTest }) {
      ...
      <div class="space-y-3">
        ...
        {(recommendations || []).map((rec) => (
          <div key={rec.id} class="bg-white rounded-2xl p-5 border border-amber-100 shadow-sm flex items-start justify-between gap-3">
            ...
            <button
              onClick={() => {
                if (rec.recommendation_type === 'practice_set') onOpenTest();
